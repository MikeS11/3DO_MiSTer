...
//			if (LINE0) PFL <= 0;
	...
	wire         CFB_DRAM0_SEL = (SE_LEFT_ADDR[23:2] >= (24'h000000>>2) && SE_LEFT_ADDR[23:2] <= (24'h0FFFFF>>2));
	wire         CFB_DRAM1_SEL = (SE_LEFT_ADDR[23:2] >= (24'h100000>>2) && SE_LEFT_ADDR[23:2] <= (24'h1FFFFF>>2));
	...
	assign LA       = SE_GRANT && CFB_ACCESS ? (SE_RIGHT_WRITE ? SE_RIGHT_ADDR[23:2] : SE_LEFT_ADDR[23:2]) : CPU_GRANT && CPU_SPORT_SEL ? {4'b0000,AOUT[10:2],9'b000000000} : AOUT;
	...
	assign RA       = SE_GRANT && CFB_ACCESS ? (SE_RIGHT_WRITE ? SE_RIGHT_ADDR[23:2] : SE_LEFT_ADDR[23:2]) : CPU_GRANT && CPU_SPORT_SEL ? {4'b0000,AOUT[10:2],9'b000000000} : AOUT;
